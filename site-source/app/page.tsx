      ...
      <aside className="profile" aria-label="Profile">
        ...
        <div className="profile-text">
          ...
          <div className="contact-links" aria-label="Contact and profiles">
            ...
            <a className="social-link" href="/KabeenKim_CV.pdf?v=4b93d71b1f7f" target="_blank" rel="noreferrer" aria-label="Curriculum Vitae (PDF)" title="CV"><SocialIcon name="cv" /><span>CV</span></a>
          </div>
        </div>
      </aside>
