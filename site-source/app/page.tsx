...
const experience = [
  ...
  { mark: 'DMKD', tone: 'dmkd', logo: '/logos/duksung.png', organization: 'DMKD Lab · Duksung Women’s University', role: 'Undergraduate Researcher · LLM Reasoning & Document Understanding', advisor: { name: 'Prof. Jehyeok Rew', href: 'https://lab.researchwho.com/DSWU-DMKD/member/' }, date: 'Mar 2025 – Feb 2026', location: 'Seoul, South Korea' },
  { mark: 'CV', tone: 'cvlab', logo: '/logos/olemiss.png', organization: 'Computer Vision Lab · University of Mississippi', role: 'Undergraduate Researcher · Low-Light Human Pose Estimation', advisor: { name: 'Prof. Bo Wang', href: 'https://olemiss.edu/profiles/hbw' }, date: 'Aug 2024 – Feb 2025', location: 'Mississippi, United States' },
];
      ...
      <main id="main-content">
        ...
        <section id="news" className="content-section" aria-labelledby="news-title">
          ...
          <ul className="news-list">
            ...
            <li><time dateTime="2025-10">2025.10:</time> Our team placed <strong>3rd out of 210 teams</strong> in the Samsung AI Challenge — Visually-Rich Document Understanding track.</li>
